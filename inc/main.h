...
#define GPS_CONF_BAUDRATE 9600
#define GPS_CONF_WORDLENGTH UART_WORDLENGTH_8B
#define GPS_CONF_STOPBITS UART_STOPBITS_1
#define GPS_CONF_PARITY UART_PARITY_NONE
